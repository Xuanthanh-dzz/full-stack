...
| 06 | 14/14 | 3 | 3 | 1 | PASS, samples 2026-09-22; docs/links 2026-09-23 | PENDING | PENDING |
...
- Module 01 đã retrofit cấu trúc v4, gate local và CI remote PASS; maintainer review còn pending. Module 02 đã retrofit v4, gate local và CI remote PASS; maintainer review còn pending. Module 03 đã retrofit v4, gate local và CI remote PASS; maintainer review còn pending. Module 04 đã retrofit v4, gate local và CI remote PASS; maintainer review còn pending. Module 05 đã retrofit v4, gate local và CI remote PASS; maintainer review còn pending. Module 06 đã retrofit v4, gate local PASS; CI remote và maintainer review còn pending. Module 07–08 giữ trạng thái legacy cho đến lượt retrofit; không được coi là đã đạt v4.
