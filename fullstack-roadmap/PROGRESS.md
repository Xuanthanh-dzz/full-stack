...
|---|---:|---:|---:|---:|---|---|---|
| 01 | 15/15 | 3 | 3 | 1 | PASS, 2026-09-22 | PENDING — GitHub CLI chưa đăng nhập | PENDING |
| 02 | 0/15 | — | — | — | Chưa retrofit | — | — |
...
- Module 01 đã retrofit cấu trúc v4 và chạy lại gate local; CI remote/maintainer review còn pending. Module 02–08 giữ trạng thái legacy cho đến lượt retrofit; không được coi là đã đạt v4.
