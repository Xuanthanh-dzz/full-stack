...
1. Nhắc lại alias bài05 trong array class và array struct.
...
2. ShippingMethod x=new ExpressShipping(2); x.CalculateFee(2.5m) trả gì và implementation nào chạy?
