...
> **Ưu tiên biên tập hiện tại:** retrofit Module 01–08 lên v4 trước Module 10. Cả tám module đã qua verifier local và CI baseline; checkpoint review nội dung vẫn đang mở. Trạng thái từng module xem [PROGRESS](./PROGRESS.md#retrofit-module-0108-khong-tang-lesson-completed). Việc rewrite không tăng số bài hoàn thành.
